class Level:
    ...
    def get_all() -> list["Level"]:
        ...
        return [
            Level(
                ...
                2,
                70,
                "Einfach - Für Reise-Anfänger"),
            # kaum verpixelt
            Level(
                "Backpacker",
                4,
                15,
                "Mittel - Für Reise-Erfahrene"),
            # mittel verpixelt
            # stark verpixelt
            Level("Globetrotter", 6, 6, "Schwer - Für Reise-Profis")
        ]
    ...
    def get_by_name(name: str) -> "Level | None":
        ...
        """
        return next((level for level in Level.get_all()
                    if level.name == name), None)
