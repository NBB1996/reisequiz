...
# Booking-Link enthält korrekten Reisezielnamen
...
# Booking-Link mit zusätzlichen Parametern
...
# Booking-Link encodiert Sonderzeichen korrekt
...
# Wikipedia-Link mit Standardsprache
...
# Wikipedia-Link mit benutzerdefinierter Sprache
...
# Wikipedia-Link mit Leerzeichen und Umlauten
def test_wikipedia_link_encoding():
    ziel = Reiseziel("München Altstadt", Kontinent("Europa"), Kategorie("Stadt"))
